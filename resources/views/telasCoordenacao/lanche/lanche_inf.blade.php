...
<div class="col-md-4">
    <div class="quant-alunos">                           
        <h2 class="quant-alunos">Lanches Cadastradas:  ({{$lanches->total()}})</h2>
            ...
            <tr>
                ...
                <td> <a href="{{url("/coordenacao/lanche_delete/$lanche->idlanche")}}" ><center> <img src="{{url('imgs/icones/deletar.png')}}" alt="lanche excluir"</center></td>
                                        ...
                                        <div class="alert alert-warning alert-dismissible" role="alert">
                                            ...
                                            <strong>Desculpe ! </strong> Nenhuma turma cadastrada, para cadastras<a href="/maruge/public/coordenacao/lanche_cad" class="alert-link"> Clique aqui.</a>
                                        </div>
                                        <tr>
