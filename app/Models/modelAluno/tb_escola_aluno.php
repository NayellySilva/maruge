...
class tb_escola_aluno extends Model {
...
public function endEscola(){
    return $this->hasOne('App\Models\modelAluno\tb_endereco','idEndereco','tb_endereco_idEndereco');
/*
 Relação inversa
return $this->belongsTo('App\Models\modelAluno\tb_endereco','tb_endereco_idEndereco', 'idEndereco');
 */
    }
    
 // Puxando todas as informações sobre a escola   
 public static function informacaoEscolar()
{    return tb_escola_aluno::select()
