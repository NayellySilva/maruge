...
<div class="titulo-pagina">
    <h1 class="titulo-pagina">{{ $titulo ?? 'Lançamento de Notas Educação Infantil - 1º Bimestre' }}</h1>
</div>  
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        @endforeach
        @endif
        <form class="form form-search form-Nu formularios" action="/coordenacao/salva_nota_1bim_inf" method="POST" send="/coordenacao/salva_nota_1bim_inf">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-7">
