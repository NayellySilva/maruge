...
<div class="caminho-din">
  ...
  <div class="row table-responsive">
    <div class="col-md-4">
        <img src="{{asset('imgs/aluno.jpg')}}">
    </div>
  <div class="col-md-7">
        <b> {{$Aluno->NomeAluno}}</b> <br>  
        <b>NASCIMENTO: </b>{{$Aluno->DataNascimento}}<br>
        <b>TURMA: </b>  {{$Aluno->NomeTurma}} <br>    
        <b>PAI: </b>  {{$Aluno->NomePai}}  <br>    
        <b>MAE: </b>  {{$Aluno->NomeMae}}<br>
    </div>
</div>
                <!-- /.table-responsive -->
            </div>
    ...
    <form  method="POST" action="/coordenacao/financeiro_pesq">
            ...
            <div class="row">                        
                ...
                <!--  PEGA OS ANOS ANTERIORES E COLOCA PARA SER SELECIONADA-->
                <!--  
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="Ano Letivo">Ano Letivo:</label>
                                    <div class="select-wrapper">
    <select class="form-control maruge-select" name="AnoLetivo" >
                                    <option></option>
    ...
    <i data-lucide="chevron-down" class="select-icon"></i>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                        ...
                                        <button type="reset" class="btn btn-default">LIMPAR</button> </br><br>
                                        
                                 @if (($OutrosBoletosAbertos->count()) == 0)
                                 <button type="button" data-toggle="collapse" href="#DEBTOS" class="btn btn-success"data-parent="#accordion" role="button"   aria-controls="collapseOne"> 
                                NÃO HÁ DÉBTOS ANTERIORES: ({{$OutrosBoletosAbertos->count()}})  </button>  <br> <br>  
                                @else
                                ...
                                Swal.fire({
  title: 'Verificar Débitos Anteriores.',
  imageUrl: '/SweetAlert2/mascote.png' ,
  imageWidth: 160,
  imageHeight: 120,
  icon: 'error',
    width: 800,
  ...
  no-repeat
    `
                                ...
                                <button type="button" data-toggle="collapse" href="#DEBTOS" class="btn btn-danger"data-parent="#accordion" role="button"   aria-controls="collapseOne">
                                            DÉBTOS ANTERIORES: ({{$OutrosBoletosAbertos->count()}}) </button>  <br> <br>  
                                @endif  
                                
                                    <button type="button" data-toggle="collapse" href="#TESTE" class="btn btn-warning"data-parent="#accordion2" role="button"   aria-controls="collapseOne">
                                        2ª VIA ANOS ANTERIORES: ({{$SegundaViaAnosAnteriores->count()}})  </button>
...
<!--  DÉBITOS ANTERIORES -->
   <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
       <!-- INICIO MODAL DE DEBTOS -->               
    <div id="DEBTOS" class="panel-collapse collapse" role="tabpanel" aria-labelledby="DEBTOS">
                <div class="panel-body">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading ">
                                <strong>DÉBTOS ANTERIORES</strong>  
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
    ...
    <div id="box">
        <table  class="table financeiro_tabela_receber"  >
            ...
            <tbody>
                @forelse($OutrosBoletosAbertos as $Boleto)
                <tr>
                    <td >{{$Boleto->Meses}}</td>
                    ...
                    <td class="info" >  {{ number_format($Boleto->tb_turmas_Mensalidade,2,",",".")}} </td>
                    @else               
                    <td class="danger">  {{ number_format($Boleto->valor_prestacao,2,",",".")}} </td>
                    @endif
                    @if(($Boleto->Carteira == "1"))
                    <td class="info" >  {{$Boleto->Carteira}} </td>
                    @else               
                    <td class="danger">  {{$Boleto->Carteira}} </td>
                    @endif
                    @if(($Boleto->Acordo == "N"))
                    <td class="info">{{$Boleto->Acordo}}</td>
                    @else               
            ...
            <td>
                ...
                <a href="{{url("/coordenacao/recibo_mensalidade/$Boleto->idcarne")}}"target="_blank">
                    <i class=" fas fa-print tamanhoIconeAzulImprimir" data-toggle="modal" data-target="#2via_desativado"
                       data-whatever_nomealuno="{{$Boleto->NomeAluno}}"
                       data-whatever_nometurma="{{$Boleto->NomeTurma}}"
                       data-whatever_meses="{{$Boleto->Meses}}"
                       data-whatever_codbarras="{{$Boleto->codbarras}}"
                ...
                @else 
                <a href="{{url("/coordenacao/recibo_acordo/$Boleto->idcarne")}}"target="_blank">
                    <i class=" fas fa-print tamanhoIconeAzulImprimir" data-toggle="modal" data-target="#2viaAcordodesativado"
                       data-whatever_nomealuno="{{$Boleto->NomeAluno}}"
                       data-whatever_nometurma="{{$Boleto->NomeTurma}}"
                       data-whatever_meses="{{$Boleto->Meses}}"
                       data-whatever_codbarras="{{$Boleto->codbarras}}"
            ...
            <td>
                ...
                @else 
                <a href="{{url("/coordenacao/recibo_acordo/$Boleto->idcarne")}}"target="_blank">
                    <i class=" fas fa-print tamanhoIconeAzulImprimir" data-toggle="modal" data-target="#2viaAcordo_desativado"
                       data-whatever_nomealuno="{{$Boleto->NomeAluno}}"
                       data-whatever_nometurma="{{$Boleto->NomeTurma}}"
                       data-whatever_meses="{{$Boleto->Meses}}"
                       data-whatever_codbarras="{{$Boleto->codbarras}}"
            ...
            @endforelse
                        ...
                        <!-- /.panel -->
                    </div>   <!-- FIM MODAL DE DEBTOS -->    
            </div>   <!--  FIM DÉBITOS ANTERIORES -->
...
<!--  SEGUNDA VIA ANOS  ANTERIORES -->
   <div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="false">
       <!-- INICIO MODAL DE DEBTOS -->               
    <div id="TESTE" class="panel-collapse collapse" role="tabpanel" aria-labelledby="TESTE">
                <div class="panel-body">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading ">
                                <strong>2ª VIA ANOS ANTERIORES</strong>  
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <div class="table-responsive">
    ...
    <div id="box">
        <table  class="table financeiro_tabela_receber"  >
            ...
            <tbody>
                @forelse($SegundaViaAnosAnteriores as $Boleto)
                <tr>
                    <td >{{$Boleto->Meses}}</td>
                    <td >{{$Boleto->codbarras}}</td>
                    <td >{{$Boleto->parcelas}}</td>
            ...
            </div>   <!--  FIM SEGUNDA VIA DÉBITOS ANTERIORES -->
...
<!-- ANO ATUAL -->
    ...
    <div id="box">
        <table  class="table financeiro_tabela_receber"  >
            ...
            <tbody>
                @forelse($TodosBoletos as $Boleto)
                <tr>
                    <td >{{$Boleto->Meses}}</td>
                    <td >{{$Boleto->codbarras}}</td>
                    <td >{{$Boleto->parcelas}}</td>
...
<div class="modal fade" id="pagamento" tabindex="-2" role="dialog" aria-labelledby="exampleModalScrollableTitle">
    ...
    <i data-lucide="chevron-down" class="select-icon"></i>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-3">
                                <div class="select-wrapper">
    <select class="custom-select my-1 mr-sm-2 form-control maruge-select" name="forma_pgto">
                                    <option></option>
                                    <option value="DINHEIRO">DINHEIRO</option>
                                    <option value="DÉBITO">DÉBITO</option>
                                    <option value="CRÉDITO">CRÉDITO</option>
                                    <option value="T.BRASIL">BOLETO</option>
                                    <option value="T.BRASIL">T.BRASIL</option>
                                    <option value="T.BRADESCO">T.BRADESCO</option>
                                    <option value="T.ITAU">T.ITAÚ</option>
                                    <option value="T.CAIXA">T.CAIXA</option>
                                    <option value="T.OUTROS">T.OUTROS</option>
...
<div class="modal fade" id="2viaAcordo" tabindex="-1" role="dialog"  aria-labelledby="exampleModalScrollableTitle">
    ...
    <div class="modal-dialog modal-dialog-scrollable" id="print" class="conteudo" role="document">
        <div class="modal-content">
            <div class="modal-header modal_Observacoes-titulo ">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal_Observacoes-titulo">2º VIA COMPROVANTE DE PAGAMENTO:</h4>
            ...
            <div > 
                <form style="font-family: Albertus MT Lt; font-size:11px">
                    {!! csrf_field() !!}
                    <div >
                        <dt  id="nomealuno2"  ></dt><br>
                        <strong>PAGAMENTO MÊS DE:</strong> <small id="meses2"></small>
                        <strong>VALOR DA PARCELA:</strong> R$ <small id="valor_prestacao2"></small><br>
                        <strong>TURMA:</strong> <small id="nometurma2"></small>
                        <strong>PARCELA:</strong> <small id="parcelas2"></small>
                        <strong>ANO:</strong> <small id="ano_letivo2"></small><br><br>
                        <strong>AUTENTICAÇÃO:</strong> <small id="codbarras2"></small><br>  
                        <strong>CARTEIRA:</strong> <small id="carteira2"></small><br>
                        <strong>VENCIMENTO:</strong> <small id="data_venc2"></small>  ><br>  
                        <strong>DATA:</strong> <small id="data_pagamento2"></small><br> 
                        <strong> ACORDO:</strong> <small id="acordo2"></small><br>
                        <strong>STATUS DE PAGAMENTO:</strong><small  id="status2"></small><br>
                        <strong>VALOR JÁ PAGO:</strong> R$ <small id="valorpgto2"></small> <br>
                        <strong>OBS.:</strong> <small id="obs_pagamento2"></small><br>  <br>
                    </div>
...
<div class="modal fade" id="2viaAcordoTes" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header modal_Observacoes-titulo ">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
