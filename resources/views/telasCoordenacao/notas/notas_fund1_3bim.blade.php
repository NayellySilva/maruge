...
<div class="titulo-pagina">
    <h1 class="titulo-pagina">{{ $titulo ?? 'Lançamento de Notas Fundamental I - 3º Bimestre' }}</h1>
</div>  
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        @endforeach
        @endif
        <form class="form form-search form-Nu formularios" action="/coordenacao/salva_nota_3bim_fun1" method="POST" send="/coordenacao/salva_nota_3bim_fun1">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="caminho-din">                    <table class="table table-hover">
                    ...
                    <td> 
                    <center><a href="#">
                            <img src="{{url('imgs/icones/editar.png')}}" data-toggle="modal" data-target="#edita_nota_3bim_fun1" 
                    ...
                    <td>
                    <center>
                        @if(isset($nota->RB3) && $nota->RB3 > 0)
                            <div class="col-md-4 col-md-offset-4">
                                <input type="text" name="RB3[{{$key}}]" value="{{ number_format($nota->RB3, 1) }}" placeholder="0.00" class="form-control nota" min="0" max="10">
                            </div>
                        @else
...
<!-- Modal Alteração Nota -->
<div class="modal fade" id="edita_nota_3bim_fun1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
