...
<div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-center">
        ...
        <div class="w-full sm:w-80">
            <form method="POST" action="{{ url('/coordenacao/boletim_pesq') }}" class="w-full">
                @csrf
            ...
            <form method="GET" action="{{ url()->current() }}" class="w-full">
                <div class="relative" id="dropdown-container-turma-boletins">
                    ...
                    <div onclick="toggleMultiDropdown('dropdown-menu-turma-boletins', 'chevron-turma-boletins')" 
                        ...
                        <span id="label-turma-boletins" class="text-sm font-medium truncate {{ $selectedTurmaBol ? 'text-[#0a241e]' : 'text-[#95aba5]' }}">
                            {{ $selectedTurmaBol ? $selectedTurmaBol->NomeTurma : 'Filtrar por Turma' }}
                        </span>
                    ...
                    <!-- Dropdown Flutuante -->
                    <div id="dropdown-menu-turma-boletins" class="hidden absolute top-full left-0 right-0 mt-1 bg-white border border-[#e3e8e6] rounded-xl shadow-xl z-50 p-2 flex flex-col gap-2 overflow-hidden" style="max-height: 240px;">
                        <!-- Campo de Busca -->
                        <div class="relative shrink-0">
                            <input type="text" onkeyup="filterDropdownOptions('search-turma-boletins', 'option-turma-boletins')" id="search-turma-boletins" placeholder="Pesquisar..." class="w-full pl-3 pr-9 py-1.5 bg-[#f8faf9] border border-[#e3e8e6] rounded-lg text-xs focus:outline-none focus:border-[#008a4b]">
