...
<div class="col-md-5">
    <div class="form-group">
        ...
        <form class="form-search pesquisar" method="post" action="/maruge/public/coordenacao/notas_pesq">
            {!! csrf_field() !!}
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <form class="form-search pesquisar"method="post" action="/maruge/public/coordenacao/notas_filtro">
           {!! csrf_field() !!}
    ...
    <table class="table table-hover">
        ...
        <center>
            <tr>
                ...
                <td> <a href="{{url("/coordenacao/lancamentos_notas_rec/$Aluno->idAluno")}}" target="_blank" ><center> <img src="{{url('imgs/icones/editar.png')}}" alt="Recuperações"</center></td>
