    ...
    <table class="table table-hover">
        ...
        <center>
            <tr>
                ...
                <td><center><a href="{{url("/coordenacao/frequencia_relatorio/$turma->idTurmas")}}"><center> <img src="{{url('imgs/icones/imprimir.png')}}" alt="frequencia de entrega de resultado"</center></td> 
                <td><center><a href="{{url("/coordenacao/frequencia_relatorio/$turma->idTurmas")}}"><center> <img src="{{url('imgs/icones/imprimir.png')}}" alt="frequencia de entrega de resultado"</center></td> 
            </tr>
            @empty
