...
class cont_notas extends Controller {
...
//Metodo do 2º bismestre que direciona o aluno para a view apropriada 
...
//Metodo do 3º bismestre que direciona o aluno para a view apropriada 
...
//Metodo do 4º bismestre que direciona o aluno para a view apropriada 
    ...
    public function salva_nota_1bim_inf() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB1"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_1bim_inf($dadosForm);
    ...
    public function salva_nota_2bim_inf() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB2"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_2bim_inf($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_3bim_inf() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB3"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_3bim_inf($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_4bim_inf() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB4"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_4bim_inf($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
...
//Metodo para salva as notas do primeiro 1bimes Fundamente I.
    public function salva_nota_1bim_fun1() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB1"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_1bim_fun1($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
...
//Metodo para salva as notas do 2 bim Fundamente I.
    public function salva_nota_2bim_fun1() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB2"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_2bim_fun1($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
...
//Metodo para salva as notas do 3 bim Fundamente I.
    public function salva_nota_3bim_fun1() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB3"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_3bim_fun1($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
...
//Metodo para salva as notas do 4 bim Fundamente I.
    public function salva_nota_4bim_fun1() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AB4"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_4bim_fun1($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_1bim_fun2() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AM1"][$i]) or ( $dadosForm["AB1"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_1bim_fun2($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_2bim_fun2() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AM2"][$i]) or ( $dadosForm["AB2"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_2bim_fun2($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_3bim_fun2() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AM3"][$i]) or ( $dadosForm["AB3"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_3bim_fun2($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_4bim_fun2() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["AM4"][$i]) or ( $dadosForm["AB4"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_4bim_fun2($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function salva_nota_rp_rf() {
        ...
        for ($i = 0; $i < $count; $i++) {
            if (!empty($dadosForm["RP"][$i]) or ( $dadosForm["RF"][$i])) {
                $salvandoNotas = tb_notas::salva_nota_rp_rf($dadosForm);
                return $salvandoNotas;
            }
        }
        return "notaNaoInformada";
    ...
    public function editarNota() {
        ...
        $disciplinas = tb_turmas_disciplinas::disciplinaTurma($idTurmas);
        $quantidade_disciplinas = tb_turmas_disciplinas::QuantidadeDisciplinasNaTurma($idTurmas);
        $updateNota = tb_notas::editandoNotas($dadosForm);
        if ($updateNota) {
