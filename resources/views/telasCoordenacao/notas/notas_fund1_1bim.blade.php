...
<div class="titulo-pagina">
    <h1 class="titulo-pagina">{{$titulo or 'Lançamento de Notas Fundamental I - 1º Bimestre'}}</h1>
</div>  
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        @endforeach
        @endif
        <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/salva_nota_1bim_fun1" method="POST" send="/maruge/public/coordenacao/salva_nota_1bim_fun1">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-7">
...
<!-- Modal Alteração Nota Educação Fundamental I -->
<div class="modal fade" id="edita_nota_1bim_fun1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
