...
<div class="titulo-endereco">
    <a href="#">
    Secretaria / Declarações 
    </a>
</div>
<div class="col-md-5">
    <div class="form-group form-buscas">
        <label for="SituacaoAluno ">Localizar aluno:</label>
        <form class="form-search pesquisar" method="post" action="/maruge/public/coordenacao/declaracoes_pesq">
            {!! csrf_field() !!}
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <form class="form-search pesquisar"method="post" action="/maruge/public/coordenacao/declaracao_filtro">
           {!! csrf_field() !!}
