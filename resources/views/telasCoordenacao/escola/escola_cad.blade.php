...
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        @if(isset($escolas))
        <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/escola_editar/{{$escolas->idEscola}}" method="POST">
            @else
            <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/escola_cad" method="POST" send="/maruge/public/coordenacao/escola_cad">
                @endif 
                {!! csrf_field() !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="email" name="EmailColegio" placeholder="E-mail" id="email" class="form-control" value="{{$escolas->EmailColegio or old('EmailColegio')}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
