       ...
       <tr>
        ...
        <center>
            <tr>
                ...
                <td> <a href="{{url("/coordenacao/gabarito_08/$turma->idTurmas")}}"><center> <img src="{{url('imgs/icones/imprimir.png')}}" alt="resultado parcial"</center></td>
                <td> <a href="{{url("/coordenacao/gabarito_10/$turma->idTurmas")}}"><center> <img src="{{url('imgs/icones/imprimir.png')}}" alt="resultado parcial"</center></td>
                <td> <a href="{{url("/coordenacao/gabarito_11/$turma->idTurmas")}}"><center> <img src="{{url('imgs/icones/imprimir.png')}}" alt="resultado parcial"</center></td>
                    </tr>
                    @empty
