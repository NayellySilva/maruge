...
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/funcionario_editar/{{$funcionario->idFuncionario}}" method="POST">
            @else
            <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/funcionario_cad" method="POST" send="/maruge/public/coordenacao/funcionario_cad">
                @endif 
                {!! csrf_field() !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="email" name="EmailFuncionario" placeholder="E-mail"  class="form-control" value="{{$endereco->EmailFuncionario or old('EmailFuncionario')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="texto" name="Salario" placeholder="R$ 0,00" id="Salario" class="form-control" value="{{$funcionario->Salario or old('Salario')}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
