...
<div class="titulo-pagina">
    <h1 class="titulo-pagina">{{$titulo or 'Lançamento de Notas de Recuperações'}}</h1>
</div>  
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        @endforeach
        @endif
        <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/salva_nota_rp_rf" method="POST" send="/maruge/public/coordenacao/salva_nota_rp_rf">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-7">
                    ...
                    <table class="table table-hover">
                        ...
                        <center>
                            <tr>
                                ...
                                @if (isset ($nota->RP)) <!-- Verifica no banco de dados se existe uma linha expecifica referente a busca a cima. RP APENAS UMA REFERENCIA QUALQUER PODERIA SER QUALQUER UM -->
                                @if (($nota->RP) == 0 && ($nota->RF) == 0 )
                                <td>
                            <center>
                                <div class="col-md-4 col-md-offset-4" >                                  
                                    <input type="text" name="RP[{{$key}}]"placeholder="0.00"  class="form-control nota" min="0" max="10" >
                                </div>  
                            </center> 
                            </td>
                            <td>
                            <center>
                                <div class="col-md-4 col-md-offset-4" >                                  
                                    <input type="text" name="RF[{{$key}}]"placeholder="0.00"  class="form-control nota" min="0" max="10" >
                                </div>  
                            </center> 
                            </td>
                            <td>
                            ...
                            <td>
                            <center> 
                                <div class="col-md-4 col-md-offset-4 notaVermelha">{{number_format($nota->RP ,1)}}
                                    <input type="hidden" name="RP[{{$key}}]" value="{{$nota->RP}}" >
                                </div>
                            </center>
                            </td>
                            <td>
                            ...
                            <td>
                            <center> 
                                <div class="col-md-4 col-md-offset-4 notaAzul">{{number_format($nota->RP ,1)}}
                                    <input type="hidden" name="RP[{{$key}}]" value="{{$nota->RP}}" >
                                </div>
                            </center>
                            </td>
                            ...
                            <center> 
                                <a href="#">
                                    <img src="{{url('imgs/icones/editar.png')}}" data-toggle="modal" data-target="#edita_nota_RP" 
                                         data-whatever_tb_aluno_idaluno="{{$aluno->idAluno}}"
                                         data-whatever_idnotas="{{$nota->idNotas}}"
                                         data-whatever_nome_aluno="{{$aluno->NomeAluno}}"
                                         data-whatever_rp="{{number_format($nota->RP ,1)}}"
                            ...
                            <td>
                            <center> 
                                <div class="col-md-4 col-md-offset-4 notaVermelha">{{number_format($nota->RF ,1)}}
                                    <input type="hidden" name="RF[{{$key}}]" value="{{$nota->RF}}" >
                                </div>
                            </center>
                            </td>
                            <!-- fim da condição do vermelho -->
                            ...
                            <td>
                            <center> 
                                <div class="col-md-4 col-md-offset-4 notaAzul">{{number_format($nota->RF ,1)}}
                                    <input type="hidden" name="RF[{{$key}}]" value="{{$nota->RF}}" >
                                </div>
                            </center>
                            </td>
                            ...
                            <center> 
                                <a href="#">
                                    <img src="{{url('imgs/icones/editar.png')}}" data-toggle="modal" data-target="#edita_nota_RF" 
                                         data-whatever_tb_aluno_idaluno="{{$aluno->idAluno}}"
                                         data-whatever_idnotas="{{$nota->idNotas}}"
                                         data-whatever_nome_aluno="{{$aluno->NomeAluno}}"
                                         data-whatever_rf="{{number_format($nota->RF ,1)}}"
                                         data-whatever_disciplina="{{$disciplina->NomeDisciplina}}"
                                         data-whatever_idusuario="{{auth()->guard('guardLogin')->user()->idUsuario}}"
                                         >
                                </a>
                            ...
                            <center> 
                                <a href="#">
                                    <img src="{{url('imgs/icones/editar.png')}}" data-toggle="modal" data-target="#edita_nota_RP_RF" 
                                         data-whatever_tb_aluno_idaluno="{{$aluno->idAluno}}"
                                         data-whatever_idnotas="{{$nota->idNotas}}"
                                         data-whatever_nome_aluno="{{$aluno->NomeAluno}}"
                                         data-whatever_rp="{{number_format($nota->RP ,1)}}"
...
<!-- Modal Alteração Nota 1º RP SO -->
<div class="modal fade" id="edita_nota_RP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="alteraNota form formularios" action="/maruge/public/coordenacao/editar_nota" method="POST" send="/maruge/public/coordenacao/editar_nota">
                    ...
                    <div class="row ">
                        <div class="col-md-12 ">
                            <label for="RP" id="Disciplina"></label>   
                        </div>  
                        <div class="col-md-2 col-md-offset-5">
                            <input type="text" name="RP" class="form-control nota" min="0" max="10" id="notaAtual" >
                        </div>  
                    </div>  
...
<!-- Modal Alteração Nota RECUPERAÇÃO FINAL -->
<div class="modal fade" id="edita_nota_RF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header alteraNota-titulo">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <form class="alteraNota form formularios" action="/maruge/public/coordenacao/editar_nota" method="POST" send="/maruge/public/coordenacao/editar_nota">
                    ...
                    <div class="row ">
                        <div class="col-md-12 ">
                            <label for="RF" id="Disciplina"></label>   
                        </div>  
                        <div class="col-md-2 col-md-offset-5">
                            <input type="text" name="RF" class="form-control nota" min="0" max="10" id="notaAtual" >
                        </div>  
                    </div>  
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
...
<!-- Modal Alteração Nota DE RECUPERAÇÃO PARCIAL E FINAL -->
<div class="modal fade" id="edita_nota_RP_RF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header alteraNota-titulo">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <form class="alteraNota form formularios" action="/maruge/public/coordenacao/editar_nota" method="POST" send="/maruge/public/coordenacao/editar_nota">
                    ...
                    <div class="row ">
                        <div class="col-md-2 col-md-offset-4" >
                            <div class="form-group">
                                <label for="RP">PARCIAL:</label>
                                <center>
                                    <input type="text" name="RP" class="form-control nota" min="0" max="10" id="notaAtualRP" >    
                                </center>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="RF">FINAL:</label>
                                <center>
                                    <input type="text" name="RF" class="form-control nota" min="0" max="10" id="notaAtualRF" >    
                                </center>   
                            </div>
                        </div>
                    </div> 
