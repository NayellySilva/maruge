...
<div class="col-md-4">
    <div class="quant-alunos">
        <h2 class="quant-alunos">Total de Alunos: ({{$Alunos->total()}})</h2>
    </div> 
</div>
            ...
            <tr>
                ...
                <td> <center> <img src="{{url('imgs/icones/ativo.png')}}" </td>
                    ...
                    <td> <center> <img src="{{url('imgs/icones/inativo.png')}}" </td>
                        @endif      
                        <td> <a href="{{url("/coordenacao/aluno_pre_matricula/$Aluno->idAluno")}}" ><center> <img src="{{url('imgs/icones/editar.png')}}" alt="editar"</center></td>
                        </tr>         
                        @empty
                        ...
                        <tr>
                            <td colspan="500"> Nenhum aluno encontrado !</td>
                        </tr>
                        @endforelse
                        </table> 
