...
<div class="col-md-5">
    <div class="form-group">
        ...
        <form class="form-search pesquisar" method="post" action="/maruge/public/coordenacao/boletim_pesq">
            {!! csrf_field() !!}
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <form class="form-search pesquisar"method="post" action="/maruge/public/coordenacao/boletim_filtro">
            {!! csrf_field() !!}
