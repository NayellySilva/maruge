...
<div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-center">
        ...
        <div class="w-full sm:w-80">
            <form method="POST" action="{{ url('/coordenacao/relatorios_pesq') }}" class="w-full">
                @csrf
            ...
            <form method="GET" action="{{ url()->current() }}" class="w-full">
                <div class="relative" id="dropdown-container-turma-relatorios-bimestrais">
                    ...
                    <div onclick="toggleMultiDropdown('dropdown-menu-turma-relatorios-bimestrais', 'chevron-turma-relatorios-bimestrais')" 
                        ...
                        <span id="label-turma-relatorios-bimestrais" class="text-sm font-medium truncate {{ $selectedTurmaBim ? 'text-[#0a241e]' : 'text-[#95aba5]' }}">
                            {{ $selectedTurmaBim ? $selectedTurmaBim->NomeTurma : 'Filtrar por Turma' }}
                        </span>
                    ...
                    <!-- Dropdown Flutuante -->
                    <div id="dropdown-menu-turma-relatorios-bimestrais" class="hidden absolute top-full left-0 right-0 mt-1 bg-white border border-[#e3e8e6] rounded-xl shadow-xl z-50 p-2 flex flex-col gap-2 overflow-hidden" style="max-height: 240px;">
                        <!-- Campo de Busca -->
                        <div class="relative shrink-0">
                            <input type="text" onkeyup="filterDropdownOptions('search-turma-relatorios-bimestrais', 'option-turma-relatorios-bimestrais')" id="search-turma-relatorios-bimestrais" placeholder="Pesquisar..." class="w-full pl-3 pr-9 py-1.5 bg-[#f8faf9] border border-[#e3e8e6] rounded-lg text-xs focus:outline-none focus:border-[#008a4b]">
