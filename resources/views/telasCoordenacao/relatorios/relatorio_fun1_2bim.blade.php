<html>
    ...
    <body>
        ...
        <div class="boletin-acompanhamento-titulo"> BOLETIM DE ACOMPANHAMENTO - FUNDAMENTAL I <br> 2º BIMESTRE - <strong>
...
<th width="80"><center>MÉDIA</center></th>
    ...
    <tr>
        ...
        @if (isset ($nota->AB1))
                                        ...
                                        <!--CAMPOS DE DA TABELA DE RECUPERAÇÃO-->
                                                    ...
                                                    @endif
                                        <!-- / CAMPOS DE DA TABELA DE RECUPERAÇÃO-->
                                        <!--CAMPOS DE MEDIA E SITUAÇÃO SE NÃO EXISTIR NORA DE RECUPERAÇÃO PARCIAL -->  
                                @if(($nota->RP) == 0)
                                                    <!-- FAZENDO A MEDIA -->
                                                    @php 
                                                    ...
                                                    @endif
                                        <!-- CAMPO MEDIA E RECUPERAÇÃO QUANDO EXISTIR NOTA DE RECUPERAÇÃO PARCIAL -->
                                @else
                                    @if(($nota->RP) < 7)      
                                    <td><center><div class="  notaVermelha">{{number_format($nota->RP ,1)}}</div></center></td> 
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Códigos de Disciplinas', '1º Bimestre', '2º Bimestre'],
        @foreach($notasgraficos as $disciplina )
           ['{{ substr ($disciplina->NomeDisciplina ,0,4    )}}', '{{ $disciplina->AB1}}', '{{ $disciplina->AB2}}'],
          @endforeach
        ]);
        var options = {
          chart: {
