            ...
            <form method="POST" action="{{ url('/coordenacao/mapas_filtro') }}" class="w-full">
                ...
                <div class="relative" id="dropdown-container-sit-mapas">
                    ...
                    <div id="dropdown-menu-sit-mapas" class="hidden absolute top-full left-0 right-0 mt-1 bg-white border border-[#e3e8e6] rounded-xl shadow-xl z-50 p-1.5 flex flex-col gap-0.5">
                        <div onclick="selectSingleOption('', 'Todos', 'SituacaoTurma', 'label-sit-mapas', 'dropdown-menu-sit-mapas', 'chevron-sit-mapas', true)"
                             class="option-sit-mapas flex items-center p-2.5 hover:bg-[#ecfdf5] rounded-lg transition-colors cursor-pointer text-xs text-[#0a241e]">
                            <span class="option-title font-medium">Todos</span>
                        </div>
                        <div onclick="selectSingleOption('ATIVO', 'Ativo', 'SituacaoTurma', 'label-sit-mapas', 'dropdown-menu-sit-mapas', 'chevron-sit-mapas', true)"
                             class="option-sit-mapas flex items-center p-2.5 hover:bg-[#ecfdf5] rounded-lg transition-colors cursor-pointer text-xs text-[#0a241e]">
                            <span class="option-title font-medium">Ativo</span>
                        </div>
                        <div onclick="selectSingleOption('INATIVO', 'Inativo', 'SituacaoTurma', 'label-sit-mapas', 'dropdown-menu-sit-mapas', 'chevron-sit-mapas', true)"
                             class="option-sit-mapas flex items-center p-2.5 hover:bg-[#ecfdf5] rounded-lg transition-colors cursor-pointer text-xs text-[#0a241e]">
