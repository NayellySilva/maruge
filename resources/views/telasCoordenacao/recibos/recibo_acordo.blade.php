            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <strong>VALOR DA PRESTAÇÃO:R$:</strong>{{$boleto->valor_prestacao}}<br>
                        <strong>PARCELA:</strong>{{$boleto->parcelas}}<br>
                        <strong>VALOR PAGO:</strong>R$:{{ number_format($boleto->ValorPGTO,2,",",".")}} <br>
                        <strong>FORMA DE PAGAMENTO:</strong>{{$boleto->forma_pgto}} <br>
                    ...
                    @php 
                    $Falta = ($boleto->valor_prestacao - $boleto->ValorPGTO)
                    @endphp
