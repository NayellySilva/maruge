            ...
            <center><img src="{{url('imgs/mascote.png')}}"  width="100" height="80"alt="Colégio Carinho da Mamãe" title="Colégio Carinho da Mamãe"></center>
                ...
                <td>
                   <b>ALUNO:</b>{{$cabecario->NomeAluno}}<b> <br> 
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp; <b> Carteira:</b>{{$cabecario->Carteira}}&nbsp;&nbsp;&nbsp;&nbsp; <b> Valor da Mensalidade:</b> R$: &nbsp; {{number_format($cabecario->tb_turmas_Mensalidade,2,",",".")}}
                       <br>
                       <b>ANO LETIVO</b> -{{$cabecario->Ano_Letivo}}<b>&nbsp;&nbsp;&nbsp;&nbsp; Turma:</b> {{$cabecario->NomeTurma}} <br>
