...
<div class="titulo-pagina">
    <h1 class="titulo-pagina">{{$titulo or 'Lançamento de Notas Educação Infantil - 1º Bimestre'}}</h1>
</div>  
<div class="caminho-din">
    ...
    <div class="formularios">    
        ...
        @endforeach
        @endif
        <form class="form form-search form-Nu formularios" action="/maruge/public/coordenacao/salva_nota_1bim_inf" method="POST" send="/maruge/public/coordenacao/salva_nota_1bim_inf">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-7">
                ...
                <div class="caminho-din">
                    ...
                    <div class="col-md-4 col-md-offset-4 notaVermelha" >{{number_format($nota->AB1 ,1)}}
                        ...
                        <td> 
                            <center><a href="#">
                                    <img src="{{url('imgs/icones/editar.png')}}" data-toggle="modal" data-target="#edita_nota_1bim_inf" 
                    ...
                    @else
                    <td><center><div class="col-md-4 col-md-offset-4 notaAzul">{{number_format($nota->AB1 ,1)}} 
                            <input type="hidden" name="AB1[{{$key}}]" value="{{$nota->AB1}}" >
...
<div class="modal fade" id="edita_nota_1bim_inf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
